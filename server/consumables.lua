...
QBCore.Functions.CreateUseableItem("armor", function(source, _)
...
QBCore.Commands.Add("resetparachute", "Resets Parachute", {}, false, function(source, _)
...
QBCore.Functions.CreateUseableItem("advancedlockpick", function(source, _)
