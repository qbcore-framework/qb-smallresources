...
CreateThread(function()
    ...
    while true do
        ...
        if fireworkTime > 0 and fireworkLoc then
            DrawText3Ds(fireworkLoc.x, fireworkLoc.y, fireworkLoc.z, Lang:t('label.fireworks_time', {value = fireworkTime}))
        end
    end
end)

RegisterNetEvent('fireworks:client:UseFirework', function(itemName, assetName)
    QBCore.Functions.Progressbar("spawn_object", Lang:t("progress.spawn_object"), 3000, false, true, {
