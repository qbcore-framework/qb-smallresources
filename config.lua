...
Config.Discord = {
    ...
    ["ApplicationId"] = '1151970807296303134', -- The discord application id
    ["IconLarge"] = '512x512', -- The name of the large icon
    ["IconLargeHoverText"] = 'Synergy RP', -- The hover text of the large icon
...
Config.MapText = "Synergy RP | discord.synergyrp.com" -- This is the name / text shown above the map
